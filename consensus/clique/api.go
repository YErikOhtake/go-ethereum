...
func (api *API) GetSnapshot(number *rpc.BlockNumber) (*Snapshot, error) {
	...
	return api.clique.snapshot(api.chain, header.Number.Uint64(), header.Hash(), nil, false)
}
...
func (api *API) GetSigners(number *rpc.BlockNumber) ([]common.Address, error) {
	...
	snap, err := api.clique.snapshot(api.chain, header.Number.Uint64(), header.Hash(), nil, false)
	if err != nil {
		return nil, err
	}
